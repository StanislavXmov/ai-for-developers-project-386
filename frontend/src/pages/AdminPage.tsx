...
export function AdminPage() {
  ...
  function updateSlot(dayOfWeek: number, field: keyof SlotRow, value: string | boolean) {
    setSlots((prev) =>
  ...
  return (
    <div className="p-8">
      ...
      <h2 className="text-xl font-medium text-black mb-4">Weekly Availability</h2>
      ...
      <div className="space-y-3 mb-6">
        {slots.map((slot) => {
          const dayName = DAYS.find((d) => d.dayOfWeek === slot.dayOfWeek)?.name ?? "";
          return (
